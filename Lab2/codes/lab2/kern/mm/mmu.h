...
#define SV39_PTSHIFT         21                      // 21位，log2(PTSIZE) 应该是9+12=21


//SV39_VPN0SHIFT、SV39_VPN1SHIFT 和 SV39_VPN2SHIFT 分别表示线性地址中 VPN0、VPN1 和 VPN2 开始的偏移量
//SV39_PTE_PPN_SHIFT 表示页表项中 PPN 字段的偏移量
#define SV39_VPN0SHIFT       12                      // offset of VPN0 in a linear address 12
#define SV39_VPN1SHIFT       21                      // offset of VPN1 in a linear address 12+9
#define SV39_VPN2SHIFT       30                      // offset of VPN2 in a linear address 12+9+9
#define SV39_PTE_PPN_SHIFT   10                      // offset of PPN in a physical address PPN字段的偏移量
